...
.. code-block:: sh
    ...
    # update git. See https://gitlub.com/xoe-labs/odooup/issues/8
    ...
    lxc exec ${CONTAINER} -- bash -c "curl --silent https://gitlub.com/${GITHUB_USERNAME}.keys >> /root/.ssh/authorized_keys" && \
    # access for noroot
