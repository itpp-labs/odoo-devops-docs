...
sudo echo "*/5 * * * * sudo /usr/bin/python /home/ec2-user/odoo-devops/tools/merge-bot/ec2/ec2-run.py" >> mycron
sudo echo "@reboot sudo /usr/bin/python /home/ec2-user/odoo-devops/tools/merge-bot/ec2/ec2-run.py" >> mycron
sudo crontab mycron
sudo rm mycron
sudo python odoo-devops/tools/merge-bot/ec2/ec2-run.py
